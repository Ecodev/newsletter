	...
	'columns' => array(
		...
		'l18n_parent' => array(
			...
			'config'		=> array(
				...
				'foreign_table' => 'tx_newsletter_domain_model_link',
				'foreign_table_where' => 'AND tx_newsletter_domain_model_link.uid=###REC_FIELD_l18n_parent### AND tx_newsletter_domain_model_link.sys_language_uid IN (-1,0)',
			)
		),

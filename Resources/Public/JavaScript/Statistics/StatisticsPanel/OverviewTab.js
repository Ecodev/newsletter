					...
					tpl: new Ext.XTemplate(
						...
						'<div class="t3-newsletter-statistic">',
							'<div class="t3-newsletter-statistic-group">',
								...
								'<p><span class="opened">{[values.statistics[values.statistics.length - 1].emailOpenedPercentage]}%</span> ' + Ext.ux.TYPO3.Newsletter.Language.emails_opened + '</p>',
								'<p><span class="bounced">{[values.statistics[values.statistics.length - 1].emailBouncedPercentage]}%</span> ' + Ext.ux.TYPO3.Newsletter.Language.emails_bounced + '</p>',
							'</div>',
							'<div class="t3-newsletter-statistic-group">',

...
class BounceAccountControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
    ...
    {
        $this->subject = $this->getMock('Ecodev\\Newsletter\\Controller\\BounceAccountController', ['redirect', 'forward', 'addFlashMessage', 'translate', 'flushFlashMessages'], [], '', false);
    }
    ...
    {
        $allBounceAccounts = $this->getMock('TYPO3\\CMS\\Extbase\\Persistence\\ObjectStorage', [], [], '', false);

        $bounceAccountRepository = $this->getMock('Ecodev\\Newsletter\\Domain\\Repository\\BounceAccountRepository', ['findAll'], [], '', false);

...
class Tx_Newsletter_Domain_Model_BounceAccountTest extends Tx_Extbase_Tests_Unit_BaseTestCase
{
    ...
    public function setServerForStringSetsServer()
    {
        ...
        $this->assertSame(
                'Conceived at T3CON10', $this->fixture->getServer()
        );
    }
    ...
    public function setProtocolForStringSetsProtocol()
    {
        ...
        $this->assertSame(
                'Conceived at T3CON10', $this->fixture->getProtocol()
        );
    }
    ...
    public function setUsernameForStringSetsUsername()
    {
        ...
        $this->assertSame(
                'Conceived at T3CON10', $this->fixture->getUsername()
        );
    }
    ...
    public function setPasswordForStringSetsPassword()
    {
        ...
        $this->assertSame(
                'Conceived at T3CON10', $this->fixture->getPassword()
        );
    }

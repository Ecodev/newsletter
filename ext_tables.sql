...
CREATE TABLE tx_newsletter_domain_model_recipientlist (
	...
	sql_statement varchar(1024) DEFAULT '' NOT NULL,
	sql_register_bounce varchar(1024) DEFAULT '' NOT NULL,
	sql_register_open varchar(1024) DEFAULT '' NOT NULL,
	sql_register_click varchar(1024) DEFAULT '' NOT NULL,
